...
<?php
	...
	if (isset($_POST['submit'])) {
		...
		$required_fields = array('survey_menu_name', 'position', 'visible', 'content');
		...
		$menu_name = trim(mysql_prep($_POST['survey_menu_name']));
...
<table id="structure">
	<tr>
		...
		<td id="page">
			<h2>Edit page: <?php echo $sel_page['survey_menu_name']; ?></h2>
